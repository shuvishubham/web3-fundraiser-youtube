...
const Createcampaign = () => {
  ...
  return (
    <>
    {(connectAccount && connectAccount == 8337) ?<Form /> : <p style={{fontFamily: 'Poppins', textAlign: 'center', paddingTop: '50px'}}>Please make sure that you are connected to wallet</p>}
    </>
  )
}
